...
namespace Molytho.NeuralNetwork
{
    public class SingleNeuralLayer : ITrainableNeuralLayer
    {
        ...
        public Func<Vector<float>, Vector<float>> DifferentialActivationFunction => throw new NotImplementedException();

        public Func<Vector<float>, Vector<float>> ActivationFunction => throw new NotImplementedException();
